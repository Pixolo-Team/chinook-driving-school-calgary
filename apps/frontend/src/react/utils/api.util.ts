...
export function transformEnrollmentPayload(
  ...
  return {
    ...
    student_pickup_dropoff_address:
      enrollmentFormValue.user_info.pickup_dropoff_address || null,
    ...
    student_school_attended: enrollmentFormValue.user_info.school_attended,
