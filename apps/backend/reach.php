...
/**
 * Chinook Contact Endpoint
 * Core PHP + Supabase REST API
 *
 * Accepts a single POST request with a JSON body describing a contact
 * enquiry, validates required fields, then inserts a row into the
 * CONTACT_REQUESTS table in Supabase.
 *
...
// ---------------------------------------------------------------------------
// Step 4: Collect optional fields (may be empty strings)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Step 5: Insert the contact request into Supabase
// ---------------------------------------------------------------------------
